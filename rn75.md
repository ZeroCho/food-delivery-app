...
- [ios]에서 안 될 때는 Podfile에 pod 'react-native-config', :path => '../node_modules/react-native-config/react-native-config.podspec' 추가해보고 다음 명령어도 입력해서 node_modules 접근 권한 바꿔보기
```
